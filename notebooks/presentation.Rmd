...
tend to have strong feelings about their tools. 
Generally, the people I've worked with that use spreadsheets every
day are a different cohort of people than the ones that read and write
code every day, and they have very different work patterns and preferences, even if the calculations they are running are similar.
...
???
iOS client, an app called Juno, so you can edit your jupyter notebook from your iPad. Connects to Azure cloud notebooks or Cocalc, or your own private binder server.
...
* #### If you are building products that do quant analysis, please make them export notebooks! Don't hold the data prisoner.
...
If you found this interesting or have questions, I'd LOVE to talk,
I'll be right outside at the Kindly Ops table. Please email me
or connect on LinkedIn, I love meeting people and sharing everything
I possibly can.
